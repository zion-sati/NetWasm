...
The package follows NetWasm's documented first-preview support profile. Install
it from NuGet.org and use activated Emscripten 6.0.7, which supplies Node.js 24+
