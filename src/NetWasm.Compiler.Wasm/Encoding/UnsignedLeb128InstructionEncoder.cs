...
public sealed class UnsignedLeb128InstructionEncoder : IWasmInstructionEncoder
{
    private readonly IUnsignedLeb128Encoder _operandEncoder;

    public UnsignedLeb128InstructionEncoder(IUnsignedLeb128Encoder operandEncoder)
    {
