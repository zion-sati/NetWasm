// Managed port of Sun fdlibm k_sin.c. Upstream: biosbits/fdlibm
...
{
    private static double FdKernelSin(double x, double y, int iy)
    {
        ...
        var v = 0.0;
        var ix = 0;
        ix = FdHigh(x) & 0x7fffffff;    /* high word of x */
