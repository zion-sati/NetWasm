...
namespace System.Collections.Frozen
{
    ...
    internal sealed class DenseIntegralFrozenDictionary
    {
            ...
            where TKey : notnull
        {
            ...
            return
                typeof(TKey) == typeof(byte) ? CreateIfValid<TKey, byte, TValue>(source) :
                typeof(TKey) == typeof(sbyte) ? CreateIfValid<TKey, sbyte, TValue>(source) :
                typeof(TKey) == typeof(ushort) ? CreateIfValid<TKey, ushort, TValue>(source) :
                typeof(TKey) == typeof(short) ? CreateIfValid<TKey, short, TValue>(source) :
                typeof(TKey) == typeof(char) ? CreateIfValid<TKey, char, TValue>(source) :
                typeof(TKey) == typeof(int) ? CreateIfValid<TKey, int, TValue>(source) :
                null;
        }
