...
// Adapted from dotnet/runtime System.Collections SortedDictionary.cs at commit
...
namespace System.Collections.Generic
{
    ...
    public class SortedDictionary<TKey, TValue> : IDictionary<TKey, TValue>, IDictionary, IReadOnlyDictionary<TKey, TValue> where TKey : notnull
    {
        ...
        IEnumerator<KeyValuePair<TKey, TValue>> IEnumerable<KeyValuePair<TKey, TValue>>.GetEnumerator() =>
            Count == 0 ? SortedCollectionHelpers.GetEmptyEnumerator<KeyValuePair<TKey, TValue>>() :
            _set.GetEnumerator();
        ...
        public sealed class KeyCollection : ICollection<TKey>, ICollection, IReadOnlyCollection<TKey>
        {
            ...
            IEnumerator<TKey> IEnumerable<TKey>.GetEnumerator() =>
                Count == 0 ? SortedCollectionHelpers.GetEmptyEnumerator<TKey>() :
                GetEnumerator();
        ...
        public sealed class ValueCollection : ICollection<TValue>, ICollection, IReadOnlyCollection<TValue>
        {
            ...
            IEnumerator<TValue> IEnumerable<TValue>.GetEnumerator() =>
                Count == 0 ? SortedCollectionHelpers.GetEmptyEnumerator<TValue>() :
                GetEnumerator();
