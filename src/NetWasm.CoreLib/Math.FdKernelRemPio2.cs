// Managed port of Sun fdlibm k_rem_pio2.c. Upstream: biosbits/fdlibm
...
{
    private static int FdKernelRemPio2(Span<double> x, Span<double> y, int e0, int nx, int prec, ReadOnlySpan<int> ipio2)
    {
        ReadOnlySpan<int> init_jk = [2, 3, 4, 6];
        ReadOnlySpan<double> PIo2 = [
    ...
    recompute:
        ...
        /* compute n */
        z = ScaleB(z, q0);      /* actual value of z */
