        ...
        where TSelf : IBinaryInteger<TSelf>?
    {
        ...
        static virtual (TSelf Quotient, TSelf Remainder) DivRem(TSelf left, TSelf right, DivisionRounding mode)
        {
            ...
            switch (mode)
            {
                ...
                default:
                    {
                        throw new ArgumentException("Invalid division rounding mode.", nameof(mode));
                    }
            }
        ...
        static virtual TSelf Log10(TSelf value)
        {
            ...
            {
                throw new ArgumentOutOfRangeException(nameof(value), value, "The value must be non-negative.");
            }
