...
namespace System.Numerics.Colors
{
        ...
        where T : struct
    {
        ...
        {
            if (values.Length < 4)
                throw new ArgumentException("The span is too short for a color.", nameof(values));
        ...
        public void CopyTo(Span<T> destination)
        {
            if (destination.Length < 4)
                throw new ArgumentException("The span is too short for a color.", nameof(destination));
