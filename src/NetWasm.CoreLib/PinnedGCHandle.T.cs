// Portions derived from dotnet/runtime System.Private.CoreLib PinnedGCHandle.T.cs at commit
...
namespace System.Runtime.InteropServices
{
    ...
    public struct PinnedGCHandle<T> : IDisposable, IEquatable<PinnedGCHandle<T>>
        where T : class?
    {
        ...
        public PinnedGCHandle(T target)
        {
            ...
            _handle = (IntPtr)System.GCHandleRuntime.Create(target, 3);
        }
        ...
        public readonly unsafe void* GetAddressOfObjectData()
        {
            ...
            // The runtime resolves the object-data address while the object is pinned.
            return (void*)System.GCHandleRuntime.Address(_handle.ToInt32());
        }
