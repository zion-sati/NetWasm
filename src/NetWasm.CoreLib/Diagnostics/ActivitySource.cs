...
namespace System.Diagnostics
{
    public class ActivitySource : IDisposable
    {
        ...
        private static readonly IDiagnosticsPublicationGate s_publicationGate = new SingleReactorPublicationGate();
        ...
        private ActivitySource(string name, string? version, IEnumerable<KeyValuePair<string, object?>>? tags, object? scope, string? telemetrySchemaUrl)
        {
            ...
            s_publicationGate.Publish(() => s_activeSources.Add(this));
        ...
        {
            SynchronizedList<ActivityListener>? previousListeners = null;
            s_publicationGate.Publish(() => previousListeners = Interlocked.Exchange(ref _listeners, s_disposedListeners));
            if (previousListeners != s_disposedListeners)
            {
                s_publicationGate.Publish(() => s_activeSources.Remove(this));
            }
        }
        ...
        public static void AddActivityListener(ActivityListener listener)
        {
            ...
            bool added = false;
            s_publicationGate.Publish(() => added = s_allListeners.AddIfNotExist(listener));
            if (added)
            {
        ...
        internal static void ResetSourceFilters(ActivityListener listener)
        {
            ...
            s_publicationGate.Publish(() => s_allListeners.AddIfNotExist(listener));
        ...
        internal void AddListener(ActivityListener listener)
        {
            ...
            if (listeners is null)
            {
                ...
                if (listeners is null)
                {
                    s_publicationGate.Publish(() => newListeners.AddIfNotExist(listener));
                    return;
                }
            ...
            s_publicationGate.Publish(() => listeners.AddIfNotExist(listener));
        }
        ...
        internal void RemoveListener(ActivityListener listener)
        {
            ...
            s_publicationGate.Publish(() => listeners.Remove(listener));
        }

        internal static void DetachListener(ActivityListener listener)
        {
            s_publicationGate.Publish(() => s_allListeners.Remove(listener));
