...
namespace System.Diagnostics
{
    ...
    public partial class DiagnosticListener : DiagnosticSource, IObservable<KeyValuePair<string, object?>>, IDisposable
    {
        ...
        private sealed class AllListenerObservable : IObservable<DiagnosticListener>
        {
            ...
            {
                // The caller holds s_allListenersLock while publishing a new listener.
        ...
        private DiagnosticSubscription? _subscriptions;
        ...
        private static AllListenerObservable? s_allListenerObservable;   // callbacks for listeners created in this reactor.
